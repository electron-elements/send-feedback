...
class SendFeedback extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this._textarea.addEventListener('input', this.recheckErrorClass);
    this._titleInput.addEventListener('input', this.recheckErrorClass);
    this._button.addEventListener('click', this.onSubmitFeedback.bind(this));
  }

  disconnectedCallback() {
    this._textarea.removeEventListener('input', this.recheckErrorClass);
    this._titleInput.removeEventListener('input', this.recheckErrorClass);
    this._button.removeEventListener('click', this.onSubmitFeedback.length.bind(this));
  }
