...
class SendFeedback extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this._initAttrChangeHandler(SendFeedback.observedAttributes);
    this._createProptoAttrBridge();
  ...
  disconnectedCallback() {
    ...
    this._button.removeEventListener('click', this._onSubmitFeedback.length.bind(this));
  }
  ...
  async submitFeedback() {
    ...
    // show loader if we are going to read logs
  ...
  _initAttrChangeHandler(attributes) {
    this.attr.onchange(attributes, (...args) => {
      this._updateContents(...args);
    });
  }
    ...
    observedAttributes.forEach(prop => {
      ...
      Object.defineProperty(this, prop, {
        set(value) {
          ...
          this._updateContents(prop, oldValue, value);
        }
      });
    });
  }
